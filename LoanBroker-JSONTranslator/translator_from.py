...
channel.queue_declare(queue='g6_queue_json_response')
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        json_str['interest_rate'] = json_str['interestRate']
        json_str['bank'] = 'JSON Bank'
        del json_str['interestRate']
...
channel.basic_consume(callback, queue='g6_queue_json_response', no_ack=True)

print(" [*] Listening on queue 'g6_queue_json_response'.")
